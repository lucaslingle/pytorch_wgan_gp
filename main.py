...
parser.add_argument('--checkpoint_dir', type=str, default='checkpoints', help='fp for checkpoints generated by this app')
parser.add_argument('--model_dir', type=str, default='model', help='dirname for checkpoints generated by this model')
